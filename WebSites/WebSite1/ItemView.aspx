<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ItemView.aspx.cs" Inherits="ItemView" %>
			...
			<section>					
				<header class="major">					
					<h2>Maersk Line Container Management System</h2>					
						<span class="byline">Admin Item View </span>				
				</header>					
			</section>								
		</div>					
	</div>					                   
