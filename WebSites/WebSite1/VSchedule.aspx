<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="VSchedule.aspx.cs" Inherits="VSchedule" %>
			...
			<section>					
				<header class="major">					
					<h2>Maersk Line Container Management System</h2>					
						<span class="byline">View Schedule</span>				
				</header>					
			</section>								
		</div>					
	</div>					                   
